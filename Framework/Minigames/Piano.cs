...
public class PianoMinigame : MinigameDefBase{
    ...
    public override string BackgroundImage {get; set;} = "images/Music/Piano_Close_View.jpg";
    ...
    public void LoadUI(){
        ...
        Image Quit = new()
        {
            ImagePath = "images/Music/Quit.png",
                      X = 25,
                      Y = 25,
                      Width = 100,
                      Height = 100,
    ...
    public void PlaySound(string Note)
    {
        ...
        SoundService.PlaySound("Music_Assets/Sounds/"+Note+".wav");
